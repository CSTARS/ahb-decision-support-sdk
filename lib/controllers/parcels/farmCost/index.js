...
function createPoplarCycle(parcel, growthProfile) {
    ...
    var poplarBudget = budgetsCollection.getPoplarBudget(growthProfile.data.totalPerAcre / parcel.properties.usableSize);
    parcel.properties.ucd.poplarBudgetId = poplarBudget.budget.getId();

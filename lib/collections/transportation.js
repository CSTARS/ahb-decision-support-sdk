...
function TransportationCollection() {
  ...
  this.FUEL_COST = 2.80; // $/us_gal 2016-2017 average West Coast diesel price;
  this.TRUCK_LABOR = 21.30; // $/h  Mean hourly wage for heavy duty truck drivers in CA/OR/WA/ID May 2016
  this.DRIVERS_PER_TRUCK = 1.67;
  this.MILES_PER_GALLON = 6;
  this.OIL_ETC_COST = 0.35; // $/mile

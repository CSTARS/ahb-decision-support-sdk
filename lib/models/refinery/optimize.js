        ...
        (id, next) => {
            ...
            parcelController.collection.get(id, (parcel) => {
                growthProfilesCollection.get(parcel.properties.ucd.modelProfileId, (growthProfile) => {
                    ...
                    var transportationPerMg = parcel.properties.ucd.farmCost.poplar.avgTransportationCostPerYear / (growthProfile.data.totalPerAcre / growthProfile.data.years);
                    parcel.properties.ucd.refineryGateCost = parcel.properties.ucd.adoptionPrice + transportationPerMg;

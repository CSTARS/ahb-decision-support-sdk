        ...
        (props, next) => {
            ...
            parcelController.collection.get(props.id, (parcel) => {
                growthProfilesCollection.get(parcel.properties.ucd.modelProfileId, (growthProfile) => {
                    ...
                    var diff = parcel.properties.ucd.refineryGateCost - parcelController.collection.adoptionPrice.min;
                    if( diff === 0 ) diff = 0.001;

                    parcel.properties.ucd.adoptionPricePercentile = diff / (parcelController.collection.adoptionPrice.max - parcelController.collection.adoptionPrice.min);

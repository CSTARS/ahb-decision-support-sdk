...
function TransportationModel() {
  ...
  */
  ...
  this.getCostPerAcre = function(parcel, poplarYield) {
    ...
    // (cost * weight) + loading/unloading cost
    // TODO: then loading/Unloading cost is equal to the dry tons in $'s !?!
    // FIX: TODO:
    ...
    return costPerTon * collection.DRY_TON_TO_WET_TON * poplarYield + poplarYield;
  }

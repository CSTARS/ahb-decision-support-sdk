    ...
    var resp = {
        ...
        results : {
            ...
            refinery : {
                ...
                income : revenue.refinery.income(datastore, totals.years),
                poplarCost : revenue.refinery.poplarCost(datastore, totals.harvested, datastore.poplarPrice),
                transportationCost : revenue.refinery.transportationCost(datastore),
        ...
        var info = {
            ...
            poplar : {
                ...
                transportation : {
                    ...
                    cost : {
                        value : parcel.properties.ucd.transportationCost,
                        units : '$ / Acre'
                    }
                }
            },
